                        ...
                        <div className="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                            ...
                            <div className="flex justify-center mt-5 space-x-5">
                                <a href={github} target="_blank" rel="noopener noreferrer"
                                    className="inline-block text-gray-100"><span className="sr-only">GitHub</span><svg stroke="currentColor"
                                        fill="currentColor" strokeWidth="0" viewBox="0 0 496 512"
                                        className="w-6 h-6 text-white hover:text-gray-100" height="1em" width="1em"
                                ...
                                <a href={linkedin} target="_blank" rel="noopener noreferrer"
                                    className="inline-block text-white"><span className="sr-only">Linkedin</span><svg
